...
# def get_recommended_movie(movie):

#     data = pd.DataFrame(Movie.objects.all().values('id','name', 'description','industry__name','certification','genre__name','artists__name','tag'))



#     data['all_fields'] = data['description']+' '+data['industry__name']+' '+data['certification']+' '+data['genre__name']+' '+data['artists__name']+' '+data['tag']
    
#     data.drop(columns=['description','industry__name','certification','genre__name','artists__name','tag'],inplace=True)
