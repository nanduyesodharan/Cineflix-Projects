...
from .models import Movie,IndustryChoices,GenreChoices,LanguageChoices,ArtistsChoices,CertificationChoices
...
# from cineflix.utils import get_recommended_movie
...
#         artist_choices=ArtistsChoices

#         certification_choices=CertificationChoices

#         data={'page':'Create Movie','industry_choices':industry_choices,'genre_choices':genre_choices,'language_choices':language_choices,'artist_choices':artist_choices,'certification_choices':certification_choices}
...
class MovieDetailsView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        # recommended_movies=get_recommended_movie(movie)
